; ---------------------------------------------------------------------------
; Subroutine to fade to white (Special Stage) -- Mode 05: Green+Red (RetroKoH)
...
.addblue:
		...
		cmpi.b	#$E,d1
		beq.s	.addgreenred	; if blue is already whited out, that means only red remains
...
.addgreenred:
		...
		cmpi.b	#$E0,d1
		beq.s	.addred		; if green is already whited out, check blue
