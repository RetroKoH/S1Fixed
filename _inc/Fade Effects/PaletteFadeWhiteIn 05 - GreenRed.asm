; ---------------------------------------------------------------------------
; Subroutine to	fade in from white (Special Stage) -- Mode 05: Green+Red (RetroKoH)
...
.checkcolors:
	...
	; Check components
		...
		bne.s	.degreenred				; if yes, branch and decrement green to current colour
		cmpi.b	#$E,d2					; Does red need removal (yes if d2 is not $E)
		bne.s	.dered					; if yes, branch and decrement red to current colour
	; ---------------------------------------------------------------------------
	; This time, green and red will be reduced together on each frame, instead of separately
	; ---------------------------------------------------------------------------
		bra.s	.deblue
; ===========================================================================
