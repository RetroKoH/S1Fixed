; ---------------------------------------------------------------------------
; Subroutine to	fade in from black -- Mode 03: Blue+Green (RetroKoH)
...
.checkcolors:
	...
	; Check components
		...
		bne.s	.addbluegreen			; if yes, branch and add blue to current colour
		tst.b	d1						; Does green need adding (yes if d5 is non-zero)
		bne.s	.addgreen				; if yes, branch and add green to current colour
	; ---------------------------------------------------------------------------
	; This time, blue and green will be added together on each frame, instead of separately
	; ---------------------------------------------------------------------------
		bra.s	.addred
; ===========================================================================
...
.addbluegreen:
		...
		tst.b	d1						; Does green also need adding (yes if d5 is non-zero)
