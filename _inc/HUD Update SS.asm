...
.updatetime:
		...
		bsr.w	Hud_Mins
		locVRAM	(ArtTile_SS_HUD+$2A)*$20,d0				; ($4460) set VRAM address -- RetroKoH VRAM Overhaul
		moveq	#0,d1
	...
	if HUDCentiseconds=1	;Mercury HUD Centiseconds
.docent:
		locVRAM	(ArtTile_SS_HUD-4)*$20,d0				; Adjust HUD art and set new location
		moveq	#0,d1
...
Hud_LoadZero_SS:				; XREF: HUD_Update_SS
		locVRAM	(ArtTile_SS_HUD+$32)*$20				; ($4560) set VRAM address -- RetroKoH VRAM Overhaul	
...
Hud_LoadMarks_SS:				; XREF: HUD_Update_SS
		locVRAM	(ArtTile_SS_HUD-6)*$20					; Adjust HUD art and set new location
...
Hud_Base_SS:				; XREF: GM_Special
	...
	if HUDCentiseconds=1	; Mercury HUD Centiseconds
		...
		locVRAM	(ArtTile_SS_HUD+$16)*$20				; ($41E0) set VRAM address -- RetroKoH VRAM Overhaul
...
Hud_Lives_SS:				; XREF: Hud_ChkLives_SS
		locVRAM	(ArtTile_SS_Lives+9)*$20,d0		; ($4700) set VRAM address
		moveq	#0,d1
