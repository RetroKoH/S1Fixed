Mus07_Invincibility_Header:
	smpsHeaderStartSong 1
	smpsHeaderVoice     Mus07_Invincibility_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $08

	smpsHeaderDAC       Mus07_Invincibility_DAC
	smpsHeaderFM        Mus07_Invincibility_FM1,	$F4, $11
	smpsHeaderFM        Mus07_Invincibility_FM2,	$F4, $07
	smpsHeaderFM        Mus07_Invincibility_FM3,	$E8, $0F
	smpsHeaderFM        Mus07_Invincibility_FM4,	$E8, $0F
	smpsHeaderFM        Mus07_Invincibility_FM5,	$F4, $11
	smpsHeaderPSG       Mus07_Invincibility_PSG1,	$D0, $05, $00, fTone_05
	smpsHeaderPSG       Mus07_Invincibility_PSG2,	$DC, $05, $00, fTone_05
	smpsHeaderPSG       Mus07_Invincibility_PSG3,	$00, $03, $00, fTone_04

; FM5 Data
Mus07_Invincibility_FM5:
	smpsAlterNote       $03

; FM1 Data
Mus07_Invincibility_FM1:
	smpsSetvoice        $00
	dc.b	nRst, $30

Mus07_Invincibility_Jump00:
	...
	smpsAlterVol        $03
	smpsJump            Mus07_Invincibility_Jump00

; FM2 Data
Mus07_Invincibility_FM2:
	smpsNop             $01
	smpsSetvoice        $01
	dc.b	nRst, $30

Mus07_Invincibility_Loop05:
	...
	smpsLoop            $00, $02, Mus07_Invincibility_Loop05

Mus07_Invincibility_Loop06:
	dc.b	nB2, $06, nG2, $12, nA2, $06, nRst, nB2, nRst
	smpsLoop            $00, $02, Mus07_Invincibility_Loop06
	dc.b	nA2, $0C, nB2, nCs3, nEb3, nB2, $06, nCs3, nEb3, nF3, nCs3, nEb3
	dc.b	nF3, nFs3
	smpsNop             $01
	smpsJump            Mus07_Invincibility_Loop05

; FM3 Data
Mus07_Invincibility_FM3:
	smpsSetvoice        $00
	dc.b	nRst, $30

Mus07_Invincibility_Loop03:
	dc.b	nE6, $06, nRst, nE6, nRst, nCs6, nRst, nCs6, nRst, nD6, $12, nD6
	dc.b	$1E, nE6, $06, nRst, nE6, nRst, nCs6, nRst, nCs6, nRst, nG6, $12
	dc.b	nG6, $1E
	smpsLoop            $00, $02, Mus07_Invincibility_Loop03

Mus07_Invincibility_Loop04:
	dc.b	nRst, $06, nG5, $12, nA5, $06, nRst, $12
	smpsLoop            $00, $04, Mus07_Invincibility_Loop04
	smpsJump            Mus07_Invincibility_Loop03

; FM4 Data
Mus07_Invincibility_FM4:
	smpsSetvoice        $00
	dc.b	nRst, $30

Mus07_Invincibility_Loop01:
	dc.b	nCs6, $06, nRst, nCs6, nRst, nA5, nRst, nA5, nRst, nB5, $12, nB5
	dc.b	$1E, nCs6, $06, nRst, nCs6, nRst, nA5, nRst, nA5, nRst, nD6, $12
	dc.b	nD6, $1E
	smpsLoop            $00, $02, Mus07_Invincibility_Loop01

Mus07_Invincibility_Loop02:
	dc.b	nRst, $06, nB5, $12, nCs6, $06, nRst, $12
	smpsLoop            $00, $04, Mus07_Invincibility_Loop02
	smpsJump            Mus07_Invincibility_Loop01

; PSG1 Data
Mus07_Invincibility_PSG1:
; PSG2 Data
Mus07_Invincibility_PSG2:
	smpsStop

; PSG3 Data
Mus07_Invincibility_PSG3:
	smpsPSGform         $E7
	dc.b	nRst, $30

Mus07_Invincibility_Jump01:
	smpsNoteFill        $03
	dc.b	nMaxPSG, $0C
	smpsNoteFill        $0C
	dc.b	$0C
	...
	smpsNoteFill        $0C
	dc.b	$0C
	smpsJump            Mus07_Invincibility_Jump01

; DAC Data
Mus07_Invincibility_DAC:
	dc.b	dSnare, $06, dSnare, dSnare, dSnare, dSnare, $02, dSnare, $04, dKick, $12

Mus07_Invincibility_Loop00:
	...
	smpsLoop            $00, $02, Mus07_Invincibility_Loop00
	...
	smpsJump            Mus07_Invincibility_Loop00

; Unreachable
	smpsStop

Mus07_Invincibility_Voices:
;	Voice $00
;	$3A
