Mus03_MZ_Header:
	...
	smpsHeaderVoice     Mus03_MZ_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $02, $09

	smpsHeaderDAC       Mus03_MZ_DAC
	smpsHeaderFM        Mus03_MZ_FM1,	$E8, $15
	smpsHeaderFM        Mus03_MZ_FM2,	$E8, $0E
	smpsHeaderFM        Mus03_MZ_FM3,	$E8, $15
	smpsHeaderFM        Mus03_MZ_FM4,	$E8, $17
	smpsHeaderFM        Mus03_MZ_FM5,	$E8, $17
	smpsHeaderPSG       Mus03_MZ_PSG1,	$D0, $03, $00, fTone_08
	smpsHeaderPSG       Mus03_MZ_PSG2,	$D0, $05, $00, fTone_08
	smpsHeaderPSG       Mus03_MZ_PSG3,	$0B, $03, $00, fTone_09
...
Mus03_MZ_Jump03:
	...
	smpsCall            Mus03_MZ_Call02
	smpsJump            Mus03_MZ_Jump03
...
Mus03_MZ_Loop01:
	...
	dc.b	nG3, $12, nG3, $06
	smpsLoop            $01, $02, Mus03_MZ_Loop01
	smpsNop             $01
	smpsJump            Mus03_MZ_Jump01

Mus03_MZ_Call00:
	dc.b	nA3, $03, nRst, nA3, $06, nE4, $03, nRst, nE4, $06, nD4, $03
	dc.b	nRst, nD4, $06, nE4, $03, nRst, nE4, $06
	smpsLoop            $00, $02, Mus03_MZ_Call00

Mus03_MZ_Loop05:
	dc.b	nD4, $03, nRst, nD4, $06, nA4, $03, nRst, nA4, $06, nF4, $03
	dc.b	nRst, nF4, $06, nA4, $03, nRst, nA4, $06
	smpsLoop            $00, $02, Mus03_MZ_Loop05
	smpsReturn
...
Mus03_MZ_Loop03:
	...
	smpsLoop            $00, $02, Mus03_MZ_Loop03
	smpsJump            Mus03_MZ_Jump06
...
Mus03_MZ_PSG2:
	dc.b	nRst, $02
	smpsAlterNote       $01
	smpsJump            Mus03_MZ_PSG1

; PSG3 Data
Mus03_MZ_PSG3:
	smpsPSGform         $E7
	smpsPSGAlterVol     $FF
	dc.b	nRst, $06, nE4, $03, $03, $06, nRst, nE3, $24	; FixMusicAndSFXDataBugs
	smpsPSGAlterVol     $01

Mus03_MZ_Jump05:
	smpsCall            Mus03_MZ_Call05
...
Mus03_MZ_Loop02:
	...
	dc.b	nG4, $12, nG4, $06
	smpsLoop            $00, $02, Mus03_MZ_Loop02
	smpsPSGAlterVol     $01
	smpsJump            Mus03_MZ_Jump05
...
Mus03_MZ_Loop04:
	...
	smpsLoop            $00, $02, Mus03_MZ_Loop04
	smpsNoteFill        $00
	smpsReturn
