Mus01_GHZ_Header:
	...
	smpsHeaderVoice     Mus01_GHZ_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $03

	smpsHeaderDAC       Mus01_GHZ_DAC
	smpsHeaderFM        Mus01_GHZ_FM1,	$F4, $12
	smpsHeaderFM        Mus01_GHZ_FM2,	$00, $0B
	smpsHeaderFM        Mus01_GHZ_FM3,	$F4, $14
	smpsHeaderFM        Mus01_GHZ_FM4,	$F4, $08
	smpsHeaderFM        Mus01_GHZ_FM5,	$F4, $20
	smpsHeaderPSG       Mus01_GHZ_PSG1,	$D0, $01, $00, fTone_03
	smpsHeaderPSG       Mus01_GHZ_PSG2,	$D0, $03, $00, fTone_06
	smpsHeaderPSG       Mus01_GHZ_PSG3,	$00, $03, $00, fTone_04

; FM1 Data
Mus01_GHZ_FM1:
	smpsSetvoice        $02
	smpsPan             panRight, $00
	smpsCall            Mus01_GHZ_Call02
...
Mus01_GHZ_Loop0E:
	...
	dc.b	nC7
	smpsAlterVol        $01
	smpsLoop            $00, $0D, Mus01_GHZ_Loop0E
	dc.b	nE7, $04, nRst, $14
	smpsAlterVol        $EB
	smpsPan             panCenter, $00
...
Mus01_GHZ_Loop0C:
	dc.b	nC3, $08
	smpsLoop            $00, $18, Mus01_GHZ_Loop0C
	smpsNoteFill        $00
...
Mus01_GHZ_Loop0D:
	dc.b	nC3, $08
	smpsLoop            $00, $1D, Mus01_GHZ_Loop0D
	smpsNoteFill        $00
	dc.b	nC3, nD3, nE3

Mus01_GHZ_Jump03:
	smpsSetvoice        $01
	smpsCall            Mus01_GHZ_Call05
	smpsCall            Mus01_GHZ_Call06
	smpsNoteFill        $00
	dc.b	nC3, nD3, nE3
	smpsCall            Mus01_GHZ_Call05
	smpsCall            Mus01_GHZ_Call06
...
Mus01_GHZ_Loop0A:
	...
	dc.b	nRst, $08
	smpsLoop            $00, $02, Mus01_GHZ_Loop0A
...
Mus01_GHZ_Loop0B:
	...
	smpsLoop            $00, $02, Mus01_GHZ_Loop0B
...
Mus01_GHZ_Loop08:
	...
	dc.b	nRst, $08
	smpsLoop            $00, $02, Mus01_GHZ_Loop08
...
Mus01_GHZ_Loop09:
	...
	smpsLoop            $00, $02, Mus01_GHZ_Loop09
...
Mus01_GHZ_Loop02:
	...
	dc.b	nRst, $08
	smpsLoop            $00, $02, Mus01_GHZ_Loop02
...
Mus01_GHZ_Loop03:
	...
	smpsLoop            $00, $02, Mus01_GHZ_Loop03
...
Mus01_GHZ_Loop04:
	...
	smpsLoop            $00, $02, Mus01_GHZ_Loop04

Mus01_GHZ_Loop05:
	dc.b	nA6, nE6, nC7, nE6, nA6, nE6, nC7, nE6
	smpsLoop            $00, $02, Mus01_GHZ_Loop05

Mus01_GHZ_Loop06:
	dc.b	nAb6, nEb6, nC7, nEb6, nAb6, nEb6, nC7, nEb6
	smpsLoop            $00, $02, Mus01_GHZ_Loop06

Mus01_GHZ_Loop07:
	dc.b	nC7, nA6, nE7, nA6, nC7, nA6, nE7, nA6
	smpsLoop            $00, $02, Mus01_GHZ_Loop07
	smpsAlterVol        $0D
	smpsAlterPitch      $0C
	smpsJump            Mus01_GHZ_Jump00
...
Mus01_GHZ_Loop0F:
	...
	smpsLoop            $00, $08, Mus01_GHZ_Loop0F
	smpsNoteFill        $00
...
Mus01_GHZ_Loop00:
	...
	smpsLoop            $00, $07, Mus01_GHZ_Loop00
	dc.b	dKick, $10, dSnare, $08, dKick, $10, dSnare, $08, $08, $08

Mus01_GHZ_Loop01:
	dc.b	dKick, $10, dSnare, $08, dKick, $10, $08, dSnare, $10
	smpsLoop            $00, $07, Mus01_GHZ_Loop01
	dc.b	dKick, $10, dSnare, $08, dKick, $10, dSnare, $08, $08, $08
	smpsLoop            $01, $02, Mus01_GHZ_Loop01
	smpsJump            Mus01_GHZ_Loop01
