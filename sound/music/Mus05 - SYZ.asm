Mus05_SYZ_Header:
	...
	smpsHeaderVoice     Mus05_SYZ_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $02, $03

	smpsHeaderDAC       Mus05_SYZ_DAC
	smpsHeaderFM        Mus05_SYZ_FM1,	$F4, $11
	smpsHeaderFM        Mus05_SYZ_FM2,	$E8, $0B
	smpsHeaderFM        Mus05_SYZ_FM3,	$F4, $14
	smpsHeaderFM        Mus05_SYZ_FM4,	$F4, $18
	smpsHeaderFM        Mus05_SYZ_FM5,	$F4, $18
	smpsHeaderPSG       Mus05_SYZ_PSG1,	$D0, $06, $00, fTone_06
	smpsHeaderPSG       Mus05_SYZ_PSG2,	$E8, $07, $00, $00
	smpsHeaderPSG       Mus05_SYZ_PSG3,	$00, $05, $00, fTone_04
...
Mus05_SYZ_Jump02:
	...
	smpsModOff
	smpsAlterVol        $08
	smpsCall            Mus05_SYZ_Call09
	smpsCall            Mus05_SYZ_Call0A
...
Mus05_SYZ_FM4:
	smpsPan             panLeft, $00
	smpsAlterNote       $03
	smpsCall            Mus05_SYZ_Call01
	smpsAlterNote       $00

Mus05_SYZ_Jump00:
	smpsModSet          $01, $01, $01, $04
	smpsSetvoice        $02
	smpsCall            Mus05_SYZ_Call02
	smpsAlterVol        $FC
	dc.b	nD6, $02
	smpsCall            Mus05_SYZ_Call03
	smpsAlterVol        $04
	smpsJump            Mus05_SYZ_Jump00

Mus05_SYZ_Call02:
	smpsCall            Mus05_SYZ_Call0D
	dc.b	nA6, $30
	smpsCall            Mus05_SYZ_Call0D
...
Mus05_SYZ_Loop05:
	...
	smpsLoop            $00, $08, Mus05_SYZ_Loop05
	smpsPSGAlterVol     $FF

Mus05_SYZ_Jump03:
	dc.b	$02, nRst, nMaxPSG
	smpsJump            Mus05_SYZ_Jump03
