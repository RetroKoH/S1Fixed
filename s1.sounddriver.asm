...
; loc_71BBC:
.nosndinput:
		cmpi.b	#$00,SMPS_RAM.v_sound_id(a6)	; is song queue set for silence (empty)?
...
.inputloop:
		...
		cmpi.b	#$00,SMPS_RAM.v_sound_id(a6)	; Is SMPS_RAM.v_sound_id a $80 (silence/empty)?
...
PlaySoundID:
		...
		move.b	#$00,SMPS_RAM.v_sound_id(a6)	; reset	music flag
