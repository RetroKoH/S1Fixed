...
; VBla_Music: -- Removed in flamedriver branch
...
.waterbelow:
	...
	if S3KUnderwaterPalette
		...
		rts										; replaces the sp increment and VBla_Exit branch in flamedriver version
...
dplcTiles := 0					; 128k Boundary Check for DPLCs End
		...
		include	"_incObj/56 SYZ Floating Blocks.asm"
...
; Split these into seperate files so SonLVL can render monitors properly	
	...
	endcase
		...
		include	"_maps/SYZ Floating Blocks.asm"
		include "_maps/Horizontal Doors.asm"
		include "_maps/Vertical Doors.asm"
