; ---------------------------------------------------------------------------
; Sprite mappings - "SONIC HAS PASSED" title card + PERFECT BONUS (Optimized by RetroKoH)
; ---------------------------------------------------------------------------
...
; These mappings were originally taken straight from the title card mappings
	...
	mappingsTableEntry.w	M_Got_Perfect
...
; PERFECT is dynamically loaded right after COOL
...
M_Got_Perfect:	spriteHeader		; PERFECT
	spritePiece	-$50, -8, 4, 2, $5E, 0, 0, 0, 0		; PERF
	spritePiece	-$30, -8, 3, 2, $66, 0, 0, 0, 0		; ECT
	spritePiece	-$24, -9, 2, 1, $4C, 0, 0, 0, 0		; Small oval
	spritePiece	-$24, -1, 2, 1, $4C, 1, 1, 0, 0		; Small oval
