...
Bubbler:
		_move.l	#Bub_BblMaker,obAddr(a0)
		...
		move.b	#6,obAnim(a0)
		move.b	obSubtype(a0),d0				; get bubbler type
...
Bub_BblMaker:
		tst.b	obBubble_Flag(a0)				; any flags set?
		...
		move.b	#1,obBubble_Flag(a0)			; set flag for bubble spawn
...
; ===========================================================================
	...
	.fail:
		...
		clr.b	obBubble_Flag(a0)				; clear all flags
