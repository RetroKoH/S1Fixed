...
; ---------------------------------------------------------------------------
; OST Constants
obBas_SonicPosY:		equ objoff_30		; 2 bytes | Sonic's Y-axis position
; ---------------------------------------------------------------------------

Basaran:
		_move.l	#Bas_DropChk,obAddr(a0)
...
Bas_DropChk:
		move.w	#128,d2
		bsr.s	Bas_ChkDist				; cmp d2 to x dist between Sonic and basaran
...
Bas_DropFly:
		...
		move.w	#128,d2
		bsr.s	Bas_ChkDist				; update xflip flag and get direction to fly
