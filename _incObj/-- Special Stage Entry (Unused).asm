...
Van_RmvSonic:	; Routine 2
		...
		jsr		(AnimateSprite).w			; animate and goto Van_LoadSonic next
		cmpi.b	#2,obFrame(a0)				; is final flash frame displayed?
		bne.s	.display					; if not, branch

		tst.b	(v_player).w				; has Sonic already been removed?
