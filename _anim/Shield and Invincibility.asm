...
aniID_FlameShield:		equ	(ptr_ShiAni_Flame-Ani_Shield)/2			; 5 - Standard animation for Flame Shield
aniID_FlameDash:		equ	(ptr_ShiAni_FlameDash-Ani_Shield)/2		; 6 - Used by Sonic_JumpHeight when activating double jump
