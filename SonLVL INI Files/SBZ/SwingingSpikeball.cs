	...
	class SwingingSpikeball : ObjectDefinition
	{
		...
		public override void Init(ObjectData data)
		{
			...
			for (int i = 0; i < labels.Length; i++)
				imgs.Add(ObjectHelper.MapASMToBmp(ObjectHelper.OpenArtFile("../artnem/SYZ Large Spikeball.nem", CompressionType.Nemesis), "../_maps/Big Spiked Ball.asm", labels[i], i == 2 ? 0 : 0));
		}
